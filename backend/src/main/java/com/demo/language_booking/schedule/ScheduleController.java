...
@AllArgsConstructor
@AuthPolicy(ScheduleSecurityPolicy.class)
@RestController
...
public class ScheduleController {
    ...
    public ResponseEntity<Schedule> getById(@PathVariable long id) {
        RegularSchedule schedule = scheduleService.findById(id).orElseThrow(() -> new ResourceNotFoundException("Schedule resource does not exist"));
