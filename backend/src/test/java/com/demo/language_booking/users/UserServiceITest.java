...
public class UserServiceITest {
	...
	private UserUpdateRequest.UserUpdateRequestBuilder defaultUpdateUserRequestBuilder() {
	...
	public void testUpdateUser() {
		...
		User createdUser = userRepository.save(userMapper.mapToUser(request));
		Long id = createdUser.getId();
		UserUpdateRequest updateRequest = defaultUpdateUserRequestBuilder()
	...
	public void testAddLanguage() {
		...
		assertFalse(user.getSpokenLanguages()
				.isEmpty());

		UserLanguageLevel userLanguageLevel = user.getSpokenLanguages()
				.stream()
				.findFirst()
				.get();
		assertNotNull(user);
	...
	public void testAddLanguage_nonExistentUser() {
		assertThrows(ResourceNotFoundException.class,
				() -> userService.addLanguage(Long.MAX_VALUE, Language.fromCode("EN"), CEFRLevel.valueOf("B2")));
	}
	...
	public void testAddLanguageTwiceShouldThrow() {
		...
		assertThrows(DuplicateLanguageException.class,
				() -> userService.addLanguage(userId, spokenLanguage, otherLevel));
	}
	...
	public void testRemoveLanguage() {
		...
		Optional<UserLanguageLevel> result = userRepository.findById(userId)
				.orElseThrow()
				.getSpokenLanguages()
				.stream()
	...
	public void testRemoveLanguage_nonExistentUser() {
		assertThrows(ResourceNotFoundException.class,
				() -> userService.deleteLanguage(Long.MAX_VALUE, Language.fromCode("EN")));
	}
	...
	public void testUpdateLanguage() {
		...
		assertEquals(oldLevel,
				createdUser.getSpokenLanguages()
						.stream()
						.findFirst()
						.get()
						.getLevel());
	...
	public void testUpdateNonExistingLanguage() {
		...
		User createdUser = userRepository.save(userMapper.mapToUser(request));
		assertThrows(ResourceNotFoundException.class,
				() -> userService.updateLanguage(createdUser.getId(), Language.ENGLISH, CEFRLevel.C1));
	}
	...
	public void testUpdateLanguageNonExistingUser() {
		assertThrows(ResourceNotFoundException.class,
				() -> userService.updateLanguage(Long.MAX_VALUE, Language.ENGLISH, CEFRLevel.C1));
	}
